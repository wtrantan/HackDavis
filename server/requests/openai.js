  ...
  async getRecipeGeneration(ingredients, temperature) {
    try {
      if (ingredients.length !== 0) {
        ...
        `Finally, on the last part of the response, provide an estimated amount of calories with a number ONLY, along with all the ingredients used + amount used in the format: quanitity, measurementUnit, ingredientName`;
